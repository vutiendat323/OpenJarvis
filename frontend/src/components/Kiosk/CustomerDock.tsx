...
export function CustomerDock({
  ...
  return (
    <div className={`pointer-events-none fixed bottom-5 left-1/2 z-50 w-[min(620px,calc(100vw-2rem))] -translate-x-1/2 ${className}`}>
      ...
      >
        <svg className="pointer-events-none absolute inset-0 h-full w-full overflow-visible" viewBox="0 0 620 96" fill="none" aria-hidden="true">
          <defs>
          ...
          <path d="M34 8h552c6 0 8 5 8 10 0 6 5 8 10 8 5 0 8 3 8 10v24c0 7-3 10-8 10-5 0-10 2-10 8 0 5-2 10-8 10H34c-6 0-8-5-8-10 0-6-5-8-10-8-5 0-8-3-8-10V36c0-7 3-10 8-10 5 0 10-2 10-8 0-5 2-10 8-10Z" fill="url(#customer-dock-parchment)" stroke="#68341a" strokeWidth="2.2" />
          <path d="M36 12h548c5 0 6 4 6 8 0 6 6 8 10 8 4 0 7 3 7 10v20c0 7-3 10-7 10-4 0-10 2-10 8 0 4-1 8-6 8H36c-5 0-6-4-6-8 0-6-6-8-10-8-4 0-7-3-7-10V38c0-7 3-10 7-10 4 0 10-2 10-8 0-4 1-8 6-8Z" stroke="#68341a" strokeWidth="1.2" strokeOpacity=".8" />
        </svg>

        <div
          data-testid="customer-dock-medallion"
          style={medallionStyle}
          className="pointer-events-none absolute -top-3 -bottom-3 left-0 z-10 w-1/3 transform-gpu transition-transform duration-[260ms] ease-[cubic-bezier(0.25,1,0.5,1)]"
        >
          <svg className="absolute left-1/2 h-[120px] w-[140px] -translate-x-1/2" viewBox="0 0 140 120" fill="none" aria-hidden="true">
          ...
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                <span className={`font-['Playfair_Display',serif] text-[13.5px] font-bold tracking-[0.24em] ${active ? 'text-[#fcecd7]' : 'text-[#783820]'}`}>{label}</span>
